...
contract hadcoin_ico {
    ...
    // Checking if an investor has enough Hadcoins to sell
    modifier can_sell_hadcoins(address investor, uint hadcoins_to_sell) {
        require (equity_hadcoins[investor] >= hadcoins_to_sell);
        _;
    }
    ...
    can_sell_hadcoins(investor, hadcoins_sold) {
